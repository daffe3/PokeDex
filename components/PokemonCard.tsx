  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-2 right-2 p-1 rounded-full bg-white bg-opacity-70 hover:bg-opacity-100 transition-all duration-200 z-10"
        aria-label={
          isFavorite
      ...
      <img
        ...
        onError={(e: React.SyntheticEvent<HTMLImageElement, Event>) => {
          ...
          e.currentTarget.src = `https://placehold.co/150x150/e0e0e0/000000?text=${imageAltText.substring(
            0,
            5
          )}...`;
        }}
